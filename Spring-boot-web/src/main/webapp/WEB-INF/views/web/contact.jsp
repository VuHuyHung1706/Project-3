        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 mx-auto">
                    <h2 class="title-lienhe text-center mb-4"><strong>Liên hệ với chúng tôi</strong></h2>
                    <form:form id="contactForm" method="get" modelAttribute="contact">
                        ...
                        <div class="form-group mb-3">
                            <form:input path="demand" class="form-control" rows="4" placeholder="Nội dung"/>
                        </div>
                        <div class="text-center">
                            <button type="button" class="btn btn-primary px-4" id="btnAddContact">
                                Gửi liên hệ
                            </button>
                        </div>
                    </form:form>
